...
public class PipelineServiceImpl implements PipelineService {
    ...
    @Override
    public PipelineStage create(PipelineStage entity) {
        return pipelineStageRepository.save(entity);
    }

    @Override
    public PipelineStage findById(Integer integer) {
        return pipelineStageRepository.findById(integer)
    ...
    @Override
    public PipelineStage update(Integer integer, PipelineStage entity) {
        PipelineStage existing = findById(integer);
    ...
    public void delete(Integer integer) {
        pipelineStageRepository.delete(findById(integer));
    }
