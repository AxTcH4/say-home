      ...
      <div className="pt-20 px-10 max-w-7xl mx-auto">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            ...
            {/* Description */}
            <div className="mb-6">
              <h2 className="text-base font-bold text-gray-900 mb-3">Description de la propriété</h2>
            ...
            {/* Équipements */}
            <div className="mb-8">
              <h2 className="text-base font-bold text-gray-900 mb-3">Équipements & Caractéristiques</h2>
          ...
          <div className="w-64 flex-shrink-0">
            <div className="border border-gray-200 rounded p-5 shadow-sm">
              <h3 className="text-sm font-bold text-gray-900 mb-4">Réserver une visite</h3>
              <div className="mb-3">
              ...
              <div className="flex items-center gap-3 border-t border-gray-100 pt-4">
                ...
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wide">Agent responsable</p>
        ...
        {similar.length > 0 && (
          <div className="mt-4 mb-10">
            <h2 className="text-lg font-bold text-gray-900 mb-6">Propriétés similaires</h2>
        ...
        <div className="w-1/2 bg-[#1a1a1a] px-10 py-8 flex items-center justify-center">
          <div className="border border-gray-700 p-6 w-[60%]">
            <div className="flex flex-col gap-2 text-xs text-gray-300 mb-4">
              <div className="flex items-center gap-2"><MapPin size={10} /> Marrakech, Maroc</div>
              <div className="flex items-center gap-2"><span>📞</span> 0687654321</div>
              <div className="flex items-center gap-2"><span>✉️</span> S4YHOME@gmail.com</div>
            </div>
            <div className="flex gap-3 text-gray-400">
              <FaInstagram size={12} className="cursor-pointer hover:text-white" />
              <FaTwitter size={12} className="cursor-pointer hover:text-white" />
              <FaFacebookF size={12} className="cursor-pointer hover:text-white" />
              <FaYoutube size={12} className="cursor-pointer hover:text-white" />
            </div>
          </div>
        </div>
      </div>
